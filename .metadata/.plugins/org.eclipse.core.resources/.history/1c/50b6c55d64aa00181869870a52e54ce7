...
public class KeisanResultDTO {

	public String roe;
	public String roa;
	public String uriage_keijo_ratio;
	public String uriage_sori_ratio;
	public String uriage_eigyo_ratio;

	public String total_kaiten_ratio;
	public String zaiko_kaiten_ratio;

	public String ryudo_ratio;
	public String zikoshi_ratio;
	public String kotei_ratio;
	public String fusai_ratio;
